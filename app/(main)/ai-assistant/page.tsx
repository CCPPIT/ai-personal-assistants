...
const onSelectAssistant = (assistant: ASSISTANT) => {
  ...
  const isSelected = selectedAssistants.some(item => item.id === assistant.id);
    ...
    <main className="container mx-auto max-w-7xl pt-16 px-6 flex-grow">
      <section className="flex flex-col items-center justify-center gap-4 pt-10 py-8 md:py-10">
        <div className="inline-block max-w-xl text-center justify-center">
          ...
          <span className={title({ color: "violet" })}>The World of &nbsp;</span>
          </BlurFade>
          <br />
              ...
              <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t-1 border-default-600 dark:border-default-100">
                <div className="flex flex-grow gap-2 items-center">
                  ...
                  <div className="flex flex-col">
                    <p className="text-tiny text-white/60">{assistant.name}</p>
                    <p className="text-tiny text-white/60">{assistant.title}&#39;</p>
                  </div>
                </div>
                <Button 
